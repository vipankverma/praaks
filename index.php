                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="navbar-header">
                                            ...
                                            <a class="navbar-brand" href="#home">
                                                <img src="assets/images/praaks_logo-white_60px 2.png"/>
                                            </a>
                                        </div>
                            ...
                            <div class="col-md-3 col-sm-6" >
                                <div class="single_pricing">
                                    ...
                                    <div class="pricing_body">
                                        <ul>
                                            <li>Design thinking services</li>
                        ...
                        <div class="main_portfolio">
                            ...
                            <div class="work_menu text-center">
                                <div id="filters" class="toolbar mb2 mt2">
                                    ...
                                    <button class="btn-md fil-cat filter" data-rel="web" data-filter=".web">
                                    Product Strategy</button>/
                                    <button class="btn-md fil-cat filter" data-rel="design" data-filter=".design">
                                    UI/UX Design</button>/
                                    <button class="btn-md fil-cat filter" data-rel="flyers" data-filter=".flyers">
                                    Branding & Graphic</button>/
                                    <button class="btn-md fil-cat filter" data-rel="bcards" data-filter=".bcards">Enterprise Systems</button>/
                                    <button class="btn-md fil-cat filter" data-rel="photo" data-filter=".photo">
                                    Web Apps</button>/
                                    <button class="btn-md fil-cat filter" data-rel="video" data-filter=".video">
                                    Mobile Apps</button>/
                            ...
                            <div id="portfoliowork">
                                ...
                                <div class="single_portfolio tile scale-anm bcards design photo" >
                                    <img src="assets/images/Recent-Work-5.jpg" alt="" />
                                ...
                                <div class="single_portfolio tile scale-anm flyers marketing design">
                                    <img src="assets/images/HDFC6.png" alt="" />
                                ...
                                <div class="single_portfolio tile scale-anm web marketing">
                                    <img src="assets/images/GD7.png" alt="" />
                                ...
                                <div class="single_portfolio tile scale-anm bcards flyers" >
                                    <img src="assets/images/Bharanys8.png" alt="" />
                                ...
                                <div class="main_counter_area text-center">
                                    ...
                                    <div class="row">
                                        <div class="single_counter border_right">
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="single_counter_item">
                                                    <i> <img src="assets/images/9.User-Favourites-32px.png" alt="" /></i>
                                        ...
                                        <div class="single_counter">
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="single_counter_item">
                                                    <i> <img src="assets/images/10.1Posts-Last-24hr-32px.png" alt="" /></i>
                                        ...
                                        <div class="single_counter">
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="single_counter_item">
                                                    ...
                                                    <i>  <img src="assets/images/11.Total-Post-32px.png" alt="" /></i>
                                        ...
                                        <div class="single_counter">
                                            ...
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="single_counter_item">
                                                    <i> <img src="assets/images/12.Amazing-feature-32px.png" alt="" /></i>
...
<div class="about_us">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-1 col-xs-1">
                                                    <figure class="single_service_icon">
                                                        <i class="fa fa"><img src="assets/images/5.UI-UX-32px.png"/></i>
                                        ...
                                        <div class="col-md-12 col-sm-10 col-xs-10 margin-bottom-60">
                                            <div class="row">:b
                                                ...
                                                <div class="col-sm-1 col-xs-1">
                                                    <figure class="single_service_icon">
                                                        <i class="fa fa"><img src="assets/images/6.Graphic-Design-32px.png"/></i>
                                                    </figure><!-- End of figure -->
                                                </div>
                                            </div>
                                        </div><!-- End of col-sm-12 -->
                                        ...
                                        <div class="col-md-12 col-sm-10 col-xs-10 margin-bottom-60">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-1 col-xs-1">
                                                    <figure class="single_service_icon">
                                                        <i class="fa fa"><img src="assets/images/7.Development-32px.png"/></i>
                                                    </figure><!-- End of figure -->
                                                </div>
                                            </div>
</div>
            ...
            <section id="form" class="BECOME OUR CLIENT">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
